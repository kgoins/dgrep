...
// ExtractEmails will return all email addresses found in the input file
func ExtractEmails(inputStrs []string) []string {
	return extractWithRegex(inputStrs, emailRegex)
}
